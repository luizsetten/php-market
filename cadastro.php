...
<body>
  <div class="container my-3 ">
    ...
    include "navbar.php";
    ?>
    <form id="formProduto" method="POST" action="./utils/store.php" class="row" enctype="multipart/form-data">
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" step="0.01" name="preco-compra" id="preco-compra" class="form-control" placeholder="Insira o preço do modelo">
        <div class="alert-danger w-100 p-2 d-none">Preço de Compra inválido</div>
      </div>
      <div class="form-group col-md-6">
        <label>Preço de Venda:</label>
        <input type="text" step="0.01" name="preco-venda" id="preco-venda" class="form-control" placeholder="Insira o preço do modelo">
